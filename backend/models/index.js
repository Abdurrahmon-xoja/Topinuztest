...
const initDb = async () => {
    try {
        ...
        if (sequelize.getDialect() === 'sqlite') {
            ...
            try { await sequelize.query("ALTER TABLE Shops ADD COLUMN tour360Url VARCHAR(255);"); } catch (e) {}
            ...
            try { await sequelize.query("ALTER TABLE Shops ADD COLUMN featuredOrder INTEGER;"); } catch (e) {}
            try { await sequelize.query("ALTER TABLE Shops ADD COLUMN categoryFeaturedOrder INTEGER;"); } catch (e) {}
