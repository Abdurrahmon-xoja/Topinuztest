...
const i18n = {
  uz: {
    ...
    cat: {
      ...
      "walls": "Devor va shiftlar",
      "floor": "Pol qoplamalari",
      "stone": "Kafel va tosh",
      "real-estate": "Eksteryer",
      "plants": "Landshaft va o'simliklar",
      "bathroom": "Vanna va santexnika",
      "other": "Turli xil",
    ...
    arOnPhone: "Telefonda AR'da ko'ring",
    arScanHint: "QR kodni telefoningiz kamerasi bilan skanerlang",
  ...
  ru: {
    ...
    cat: {
      ...
      "plants": "Ландшафт и растения",
      "bathroom": "Ванны и сантехника",
      "other": "Разное",
    ...
    arOnPhone: "Смотреть в AR на телефоне",
    arScanHint: "Отсканируйте QR-код камерой телефона",
